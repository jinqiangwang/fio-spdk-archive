...
#define SPDK_CONFIG_DPDK_DIR /root/andy/github/spdk/dpdk/build
#define SPDK_CONFIG_ENV /root/andy/github/spdk/lib/env_dpdk
#define SPDK_CONFIG_EXAMPLES 1
#undef SPDK_CONFIG_FC
#define SPDK_CONFIG_FC_PATH 
#define SPDK_CONFIG_FIO_PLUGIN 1
#define SPDK_CONFIG_FIO_SOURCE_DIR /root/andy/github/fio
